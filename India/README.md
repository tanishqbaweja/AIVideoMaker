...
3. Install WhisperX for local alignment:
   ...
   Download the 360 MB wav2vec2 alignment model once from the parent project. Both the main and India projects use this shared local copy; pipeline runs never download it:
