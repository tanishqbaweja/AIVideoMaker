...
const defaultPrompt = "The History of Rome in 40 seconds";
const defaultVibe = "Epic and Fast-Paced";

const topicOptions = [
  { id: "", label: "Custom (use prompt below)" },
  { id: "obscure-facts", label: "Obscure Facts Engine" },
  { id: "sounds-fake-but-real", label: "Sounds Fake But Real" },
  { id: "creepy-knowledge", label: "Creepy Knowledge" },
  { id: "tiny-mistakes-huge-consequences", label: "Tiny Mistakes → Huge Consequences" },
  { id: "hidden-human-abilities", label: "Hidden Human Abilities" },
  { id: "internet-mysteries", label: "Internet Mysteries" },
  { id: "things-that-shouldnt-exist", label: "Things That Shouldn't Exist" },
  { id: "psychology-tricks", label: "Psychology Tricks" },
  { id: "dark-side-of-everyday-things", label: "Dark Side of Everyday Things" },
  { id: "one-insane-story", label: "One Insane Story" }
] as const;
