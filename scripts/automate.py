...
TOPICS = [
    "obscure-facts",
    "sounds-fake-but-real",
    "creepy-knowledge",
    "tiny-mistakes-huge-consequences",
    "hidden-human-abilities",
    "internet-mysteries",
    "things-that-shouldnt-exist",
    "psychology-tricks",
    "dark-side-of-everyday-things",
    "one-insane-story",
]

TOPIC_TO_TAGS_FILE = {
    "obscure-facts": "tags/obscure_facts_engine.txt",
    "sounds-fake-but-real": "tags/sounds_fake_but_real.txt",
    "creepy-knowledge": "tags/creepy_knowledge.txt",
    "tiny-mistakes-huge-consequences": "tags/tiny_mistakes_huge_consequences.txt",
    "hidden-human-abilities": "tags/hidden_human_abilities.txt",
    "internet-mysteries": "tags/internet_mysteries.txt",
    "things-that-shouldnt-exist": "tags/things_that_shouldnt_exist.txt",
    "psychology-tricks": "tags/psychology_tricks.txt",
    "dark-side-of-everyday-things": "tags/dark_side_of_everyday_things.txt",
    "one-insane-story": "tags/one_insane_story.txt",
}

TOPIC_LABELS = {
    "obscure-facts": "Obscure Facts Engine",
    "sounds-fake-but-real": "Sounds Fake But Real",
    "creepy-knowledge": "Creepy Knowledge",
    "tiny-mistakes-huge-consequences": "Tiny Mistakes -> Huge Consequences",
    "hidden-human-abilities": "Hidden Human Abilities",
    "internet-mysteries": "Internet Mysteries",
    "things-that-shouldnt-exist": "Things That Shouldn't Exist",
    "psychology-tricks": "Psychology Tricks",
    "dark-side-of-everyday-things": "Dark Side of Everyday Things",
    "one-insane-story": "One Insane Story",
}
